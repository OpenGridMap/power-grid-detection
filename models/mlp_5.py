...
def train(data, lr=0.001, batch_size=256, n_epochs=20, input_shape=(48, 48, 3)):
    ...
    csv_logger = CSVLogger('mlp_5_a1_1o_training.log')
    # model_checkpointer = ModelCheckpoint(filepath="./mlp_5_a1_weights.hdf5", verbose=1, save_best_only=False)
    best_model_checkpointer = ModelCheckpoint(filepath="./mlp_5_a1_1o_weights_best.hdf5", verbose=1, save_best_only=True)
...
if __name__ == '__main__':
    train(load_dataset(), n_epochs=500, batch_size=2048)
